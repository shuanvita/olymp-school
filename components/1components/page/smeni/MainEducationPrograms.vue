...
<template>
  ...
  >
    ...
    <div class="lg:px-primary-padding-layout-r">
      <div class="relative">
        ...
        >
          ...
          >
            <div
              class="flex flex-col gap-y-5 md:px-10 px-4 pt-10 sm:rounded-base rounded-2xl md:aspect-[0.74] aspect-[0.52] @container w-full bg-primary text-white relative transition-colors"
            >
              <div class="contents">
                <BaseHeading
                  as="h3"
              ...
              <BaseButton @click="ym_event('vibrat_program')" :as="a" :href="slide.link" class="mx-auto mt-auto mb-8 border-white bg-white text-black z-10">
                {{ slide.btn_name }}
              </BaseButton>
            </div>
          </SwiperSlide>
          ...
          >
            ...
            >
              ...
              <BaseButton :as="a" :href="slide.link" class="mx-auto mt-auto mb-8 border-white bg-white text-black z-10">
                {{ slide.btn_name }}
              </BaseButton>
            </div>
          </SwiperSlide>
    ...
    <div class="px-primary-padding-layout-r flex">
