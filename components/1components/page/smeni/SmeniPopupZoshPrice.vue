...
console.log(answer);
  try {
    ...
    const formData = new FormData();
      ...
      formData.set("idMer", smeniRef.value.selectedPerson.id);
      formData.set("firstName", values.firstName);
      formData.set("lastName", values.lastName);
      formData.set("question", values.question);
      formData.set("raspisanie", values.raspisanie);
      formData.set("smeni_2", smeniRef.value.selectedPerson.id);
